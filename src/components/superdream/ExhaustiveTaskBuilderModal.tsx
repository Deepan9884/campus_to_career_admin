...
export function ExhaustiveTaskBuilderModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md animate-in fade-in">
      <div className="w-full max-w-4xl max-h-[92vh] rounded-2xl bg-slate-900 border border-indigo-500/40 shadow-2xl flex flex-col text-white overflow-hidden relative">
        {/* Header */}
