          ...
          <div className="w-full max-w-md space-y-7">
            ...
            <div className="rounded-3xl p-8 space-y-6 relative overflow-hidden bg-slate-900/90 border border-slate-800 shadow-2xl backdrop-blur-2xl text-white">
              ...
              <div className="grid grid-cols-2 gap-3 relative z-10">
                {hasRealClientId ? (
                  <div className="w-full flex items-center justify-center overflow-hidden rounded-xl border border-slate-800 hover:border-slate-700 transition-all [&>div]:w-full [&>div>iframe]:!w-full min-h-[40px] opacity-95 hover:opacity-100">
                    <GoogleLogin
                  ...
                  <button
                    ...
                    className="w-full bg-slate-950/70 hover:bg-slate-800/80 border border-slate-800 hover:border-slate-700 text-slate-200 font-medium text-xs sm:text-sm py-2.5 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 min-h-[40px]"
                  >
